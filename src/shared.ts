...
// Every language the APWorld can generate a game for. Kept in sync with
// `get_all_supported_languages()` in the APWorld's Languages.py.
export const supportedLangSlugs: string[] = [
  "python3",
  "javascript",
  "typescript",
  "golang",
